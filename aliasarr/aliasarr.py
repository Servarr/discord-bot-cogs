...
log = logging.getLogger("red.cogs.aliasarr")
...
class Aliasarr(commands.Cog):
    ...
    async def call_alias(self, message: discord.Message, prefix: str, alias: AliasarrEntry):
    ...
    async def paginate_alias_list(
        self, ctx: commands.Context, alias_list: List[AliasarrEntry]
    ) -> None:
